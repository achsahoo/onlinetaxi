...
public ResponseEntity<Optional<BookingDetails>> findbyidjson(@PathVariable("id") Long id)

{
	ResponseEntity<Optional<BookingDetails>> ob=null;
	Optional<BookingDetails> detail = taxiservice.showbyid(id);
	ob=new ResponseEntity<>(detail,HttpStatus.OK);
